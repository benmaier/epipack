...
eta = infection_rate = 2
beta = recovery_rate = 1
...
MetaPop.set_temporal_epi_rates({
        10: {
            'a': {
                    'quadratic': [
                            ( 'S', 'I', 'S', -infection_rate*4),
                            ( 'S', 'I', 'I', +infection_rate*4),
                        ],
                    'linear' : [
                            ( 'I', 'R', recovery_rate/2),
                        ]
...
print(MetaPop.linear_updates[-1][-1][-1])
print(MetaPop.linear_updates)
print(MetaPop.quadratic_updates)
