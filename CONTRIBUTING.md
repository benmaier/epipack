...
When contributing to this repository, please first discuss the change you wish to make via an [issue](https://github.com/benmaier/XXXPACKAGENAME/issues/new).

Please note we have a [code of conduct](https://github.com/benmaier/XXXPACKAGENAME/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
3. Increase the version number in [XXXPACKAGENAME/metadata.py](https://github.com/benmaier/XXXPACKAGENAME/blob/master/XXXPACKAGENAME/metadata.py) and the README.md to the new version that this
